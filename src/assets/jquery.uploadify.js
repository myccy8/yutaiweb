        ...
        init: function (options, swfUploadOptions) {
            ...
            return this.each(function () {
                ...
                var settings = $.extend({
                    ...
                    swf: '/images/uploadify.swf',  // The path to the uploadify SWF file
                ...
                if (args[0]) {
                    ...
                    if (args[0] == '*') {
                        ...
                        $('#' + settings.queueID).find('.uploadify-queue-item').each(function () {
                            ...
                            $(this).find('.data').removeClass('data').html('删除成功');
                        ...
                        for (var n = 0; n < args.length; n++) {
                            ...
                            $('#' + args[n]).find('.data').removeClass('data').html('删除成功');
                    ...
                    $item.find('.data').removeClass('data').html('删除成功');
        ...
        onSelect: function (file) {
            ...
            if (settings.itemTemplate == false) {
                ...
                if(fileName.toLowerCase().indexOf('png')>-1){
                    temp='<div id="${fileID}"> <span class="upload-icons image-icon"></span><span class="upload-file-name">${fileName}(${fileSize})</span>';
                }else{
                    temp='<div id="${fileID}"><span class="upload-icons attachment-icon"></span><span class="upload-file-name">${fileName}(${fileSize})</span>';
                }
                settings.itemTemplate =temp+' <span class="light-gray upload-time data flag"></span><div class="pull-right"> <a href="javascript:$(\'#${instanceID}\').uploadify(\'cancel\', \'${fileID}\')" class="red">删除</a> </div><div class="uploadify-progress"><div class="uploadify-progress-bar"></div></div>';
            ...
            if ($.inArray('onSelect', settings.overrideEvents) < 0) {
                ...
                $('#' + settings.queueID+'_content').append(itemHTML);
            }
